...
void find_native_like_allowed( double nat_phi1, double nat_psi1, double nat_ome1,
                       ...
                       double rangep,char *allowed, char *prefix)
{
    ...
    char *fmt = "%8.3f %8.3f %8.3f  %8.3f %8.3f %8.3f  %8.3f %8.3f %8.3f  %8.3f %8.3f %8.3f  %8.3f %4d  %4d  %6.1f %6.1f %6.1f %4d %4d %13d \n";
                            ...
                            if(fabs(180.0-fabs(180.0-fabs(phi3-nat_phi3))) <= rangep)
                            {
                                if(fabs(180.0-fabs(180.0-fabs(psi3-nat_psi3))) <= rangep)
                                {
                                    if(fabs(180.0-fabs(180.0-fabs(phi4-nat_phi4))) <= rangep)
                                    {
                                        ...
                                        {
                                            num_found+=1;
                                            fprintf(ofile,"%8.3f %8.3f %8.3f  %8.3f %8.3f %8.3f  %8.3f %8.3f %8.3f  %8.3f %8.3f %8.3f  %8.3f  %3d  %6.1f %6.1f %6.1f %4d %4d %13d \n",
                                            phi1, psi1, ome1, phi2, psi2, ome2, phi3, psi3, ome3, phi4, psi4, ome4, energy, hexname, DH1, DH2, DH3,nhb1,nhb2,identnum);      
                                        }
                                    }
                                }
